...
<ul class="menu-inner py-1">
  ...
  <li class="menu-item" :class="$route.path=='/store'?'active':''">
    <router-link to="/store" class="menu-link">
      ...
      <div class="text-truncate" data-i18n="Dashboards">Store</div>
    </router-link>
  </li>
  <li class="menu-item" :class="$route.path=='/cat'?'active':''">
    <router-link to="/cat" class="menu-link">
      <i class='menu-icon bx bxs-objects-horizontal-right'></i>
  ...
  <li class="menu-item"  :class="$route.path=='/transaction'?'active':''">
